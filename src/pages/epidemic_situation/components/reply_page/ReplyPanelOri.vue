  ...
  methods: {
    ...
    ossSubmit (success, error) {
      ...
      if (typeof (this.fileList[0]) != 'undefined') {
        ...
        storeAs = storeAsName + '_1.' + extraName
        ...
        client.multipartUpload(storeAs, file).then(function (result) {
          ...
          if (typeof (that.fileList[1]) != 'undefined') {
            file = that.fileList[1]
            storeAs = storeAsName + '_2.' + extraName
            ...
            client.multipartUpload(storeAs, file).then(function (result) {
              ...
              if (typeof (that.fileList[2]) != 'undefined') {
                file = that.fileList[2]
                storeAs = storeAsName + '_3.' + extraName
                that.uploadObject.push({
                  ossName: storeAs,
                  ossFileSize: file.size
                })
